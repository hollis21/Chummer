...
namespace Chummer
{
	public partial class frmOptions : Form
	{
		...
		private void cmdOK_Click(object sender, EventArgs e)
		{
            ...
            _objOptions.StartWithAverageAttributes = startWithAverageAttributesCheckbox.Checked;
            _objOptions.ContactCostUsesMultiply = contactCostUsesMultiplyCheckbox.Checked;
		...
		private void PopulateOptions()
		{
            ...
            bool startWithAverageAttributes = false;
            try
            {
                startWithAverageAttributes = _objOptions.StartWithAverageAttributes;
            }
            catch { }
            startWithAverageAttributesCheckbox.Checked = startWithAverageAttributes;

            bool contactCostUsesMultiply = false;
            try
            {
                contactCostUsesMultiply = _objOptions.ContactCostUsesMultiply;
            }
            catch { }
            contactCostUsesMultiplyCheckbox.Checked = contactCostUsesMultiply;
