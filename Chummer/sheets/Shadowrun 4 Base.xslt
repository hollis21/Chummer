						...
						<td width="100%" class="tableborder">
							<table width="100%" cellspacing="0" cellpadding="2" border="0">
								<tr>
									...
									<td colspan="4">
										<strong>PLAYER:</strong><xsl:text> </xsl:text><xsl:value-of select="playername" />
									</td>
									<td colspan="2">
										MOVEMENT: <xsl:value-of select="movement" />
									</td>
								</tr>
								<tr>
									<td colspan="4">
								...
								<tr>
									<td class="rowsummary" colspan="10">
										PERSONAL DATA
										<span class="rowsummarybutton" onClick="showhide(this,'PersonalDataBlock');" colspan="2">Show: YES</span>
										<span class="rowsummarybutton" onClick="zalomit(this,'PersonalDataBlock');" colspan="2">Page Break: NO</span>
									</td>
								</tr>
							</table>
						</td>
							...
							<table width="100%" cellspacing="0" cellpadding="0" border="0">
								...
								<tr>
									<td width="25%" class="attributecell">
										<p>
											BODY: <xsl:value-of select="attributes/attribute[name = 'BOD']/base" />
								...
								<tr>
									<td width="25%" class="attributecell">
										<p>
											AGILITY: <xsl:value-of select="attributes/attribute[name = 'AGI']/base" />
									...
									<td width="25%" class="attributecell">
										<p>
											ESSENCE: <xsl:value-of select="attributes/attribute[name = 'ESS']/base" />
										</p>
									</td>
									<td width="25%" class="attributecell">
										<p>
											...
											ASTRAL INIT: <xsl:value-of select="astralinit/base" />
												</xsl:when>
												<xsl:otherwise>
											&#160;
												</xsl:otherwise>
								...
								<tr>
									<td width="25%" class="attributecell">
										<p>
											REACTION: <xsl:value-of select="attributes/attribute[name = 'REA']/base" />
									...
									<td width="25%" class="attributecell">
										<p>
											LOGIC: <xsl:value-of select="attributes/attribute[name = 'LOG']/base" />
									...
									<td width="25%" class="attributecell">
										<p>
											MATRIX INIT: <xsl:value-of select="matrixinit/base" />
										</p>
									</td>
								</tr>
								<tr>
									<td width="25%" class="attributecell">
										<p>
											STRENGTH: <xsl:value-of select="attributes/attribute[name = 'STR']/base" />
									...
									<td width="25%" class="attributecell">
										<p>
											WILLPOWER: <xsl:value-of select="attributes/attribute[name = 'WIL']/base" />
									...
									<td width="25%" class="attributecell">
										<p>
											<xsl:if test="magenabled = 'True'">
												MAGIC: <xsl:value-of select="attributes/attribute[name = 'MAG']/base" />
											...
											<xsl:if test="resenabled = 'True'">
												RESONANCE: <xsl:value-of select="attributes/attribute[name = 'RES']/base" />
									...
									<td width="25%" class="attributecell">
										<p>
											INIT PASSES: <xsl:value-of select="ip/base" />
								...
								<tr>
									<td class="rowsummary" colspan="4">
										ATTRIBUTES
										<span class="rowsummarybutton" onClick="showhide(this,'AttributesBlock');" colspan="1">Show: YES</span>
										<span class="rowsummarybutton" onClick="zalomit(this,'AttributesBlock');" colspan="1">Page Break: NO</span>
									</td>
								</tr>
							</table>
						</td>
							...
							<table width="100%" cellspacing="0" cellpadding="0" border="0">
								...
								<tr>
									<td class="rowsummary" colspan="3">
										SKILLS
										<span class="rowsummarybutton" onClick="showhide(this,'SkillsBlock');" colspan="1">Show: YES</span>
										<span class="rowsummarybutton" onClick="zalomit(this,'SkillsBlock');" colspan="1">Page Break: NO</span>
									</td>
								</tr>
							</table>
						</td>
													...
													<table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborder">
														<tr>
															...
															<td width="30%" style="text-align:center;">
																<strong>BALLISTIC/IMPACT</strong>
															</td>
														...
														<tr>
															<td class="rowsummary" colspan="3">
																ARMOR
																<span class="rowsummarybutton" onClick="showhide(this,'ContactConditionBlock');" colspan="1">Show: YES</span>
																<span class="rowsummarybutton" onClick="zalomit(this,'ContactConditionBlock');" colspan="1">Page Break: NO</span>
															</td>
														</tr>
													</table>
												</td>
										...
										<table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborder">
											...
											<tr>
												<td class="rowsummary" colspan="8">
													RANGED WEAPONS
													<span class="rowsummarybutton" onClick="showhide(this,'WeaponBlock');" colspan="2">Show: YES</span>
													<span class="rowsummarybutton" onClick="zalomit(this,'WeaponBlock');" colspan="2">Page Break: NO</span>
												</td>
											</tr>
										</table>
									</td>
						...
						<td>
							<table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborder">
								...
								<tr>
									<td class="rowsummary" colspan="4">
										CYBERWARE/BIOWARE
										<span class="rowsummarybutton" onClick="showhide(this,'CyberwareBlock');" colspan="1">Show: YES</span>
										<span class="rowsummarybutton" onClick="zalomit(this,'CyberwareBlock');" colspan="1">Page Break: NO</span>
									</td>
								</tr>
							</table>
						</td>
							...
							<table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborder">
								...
								<tr>
									<td class="rowsummary" colspan="7">
										SPELLS
										<span class="rowsummarybutton" onClick="showhide(this,'SpellBlock');" colspan="1">Show: YES</span>
										<span class="rowsummarybutton" onClick="zalomit(this,'SpellBlock');" colspan="1">Page Break: NO</span>
									</td>
								</tr>
							</table>
						</td>
							...
							<table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborder">
									...
									<td>
										<xsl:choose>
											<xsl:when test="submersiongrade > 0">
												<strong>SUBMERSION GRADE: </strong><xsl:value-of select="submersiongrade" />
											</xsl:when>
											<xsl:otherwise>
												<strong>INITIATE GRADE: </strong><xsl:value-of select="initiategrade" />
											</xsl:otherwise>
										</xsl:choose>
									</td>
								</tr>
								...
								<tr>
									<td class="rowsummary">
										...
										<span class="rowsummarybutton" onClick="showhide(this,'InitiationBlock');" colspan="1">Show: YES</span>
										<span class="rowsummarybutton" onClick="zalomit(this,'InitiationBlock');" colspan="1">Page Break: NO</span>
									</td>
								</tr>
							</table>
						</td>
						...
						<td>
							<table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborder">
								...
								<tr>
									<td class="rowsummary" colspan="6">
										COMMLINK/PROGRAMS
										<span class="rowsummarybutton" onClick="showhide(this,'ComlinkBlock');" colspan="1">Show: YES</span>
										<span class="rowsummarybutton" onClick="zalomit(this,'ComlinkBlock');" colspan="1">Page Break: NO</span>
									</td>
								</tr>
							</table>
						</td>
							...
							<table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborder">
								...
								<tr>
									...
									<td width="25%" style="text-align:center;">
										<xsl:choose>
											...
											<xsl:otherwise>
												<xsl:choose>
													<xsl:when test="bound = 'True'">Registered</xsl:when>
								...
								<tr>
									<td class="rowsummary" colspan="4">
										...
										<span class="rowsummarybutton" onClick="showhide(this,'SpiritBlock');" colspan="1">Show: YES</span>
										<span class="rowsummarybutton" onClick="zalomit(this,'SpiritBlock');" colspan="1">Page Break: NO</span>
									</td>
								</tr>
							</table>
						</td>
						...
						<td>
							<table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborder">
								...
								<tr>
									<td class="rowsummary" colspan="3">
										CRITTER POWERS
										<span class="rowsummarybutton" onClick="showhide(this,'CritterBlock');" colspan="1">Show: YES</span>
										<span class="rowsummarybutton" onClick="zalomit(this,'CritterBlock');" colspan="1">Page Break: NO</span>
									</td>
								</tr>
							</table>
						</td>
						...
						<td>
							<table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborder">
								...
								<tr>
									<td class="rowsummary" colspan="4">
										COMPLEX FORMS
										<span class="rowsummarybutton" onClick="showhide(this,'ProgramBlock');" colspan="1">Show: YES</span>
										<span class="rowsummarybutton" onClick="zalomit(this,'ProgramBlock');" colspan="1">Page Break: NO</span>
									</td>
								</tr>
							</table>
						</td>
						...
						<td>
							<table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborder">
								...
								<tr>
									<td class="rowsummary" colspan="3">
										MARTIAL ARTS
										<span class="rowsummarybutton" onClick="showhide(this,'MartialArtsBlock');" colspan="1">Show: YES</span>
										<span class="rowsummarybutton" onClick="zalomit(this,'MartialArtsBlock');" colspan="1">Page Break: NO</span>
									</td>
								</tr>
							</table>
						</td>
							...
							<table width="100%" cellspacing="0" cellpadding="0" border="0">
								...
								<tr>
									<td colspan="3" class="indent">
										Comforts: <xsl:value-of select="comforts" />,
										Entertainment: <xsl:value-of select="entertainment" />,
										Necessities: <xsl:value-of select="necessities" />,
										Neighborhood: <xsl:value-of select="neighborhood" />,
								...
								<tr>
									<td class="rowsummary" colspan="3">
										LIFESTYLE
										<span class="rowsummarybutton" onClick="showhide(this,'LifestylesBlock');" colspan="1">Show: YES</span>
										<span class="rowsummarybutton" onClick="zalomit(this,'LifestylesBlock');" colspan="1">Page Break: NO</span>
									</td>
								</tr>
							</table>
						</td>
						...
						<td width="100%" class="tableborder">
							<table width="100%" cellspacing="0" cellpadding="0" border="0">
								...
								<tr>
									<td class="rowsummary" colspan="3">
										GEAR
										<span class="rowsummarybutton" onClick="showhide(this,'GearBlock');" colspan="1">Show: YES</span>
										<span class="rowsummarybutton" onClick="zalomit(this,'GearBlock');" colspan="1">Page Break: NO</span>
									</td>
								</tr>
							</table>
						</td>
						...
						<td width="100%" class="tableborder">
							<table width="100%" cellspacing="0" cellpadding="0" border="0">
								...
								<tr>
									<td class="rowsummary">
										DESCRIPTION
										<span class="rowsummarybutton" onClick="showhide(this,'DescriptionBlock');" colspan="1">Show: YES</span>
										<span class="rowsummarybutton" onClick="zalomit(this,'DescriptionBlock');" colspan="1">Page Break: NO</span>
									</td>
								</tr>
							</table>
						</td>
						...
						<td width="100%" class="tableborder">
							<table width="100%" cellspacing="0" cellpadding="0" border="0">
								...
								<tr>
									<td class="rowsummary">
										BACKGROUND
										<span class="rowsummarybutton" onClick="showhide(this,'BackgroundBlock');" colspan="1">Show: YES</span>
										<span class="rowsummarybutton" onClick="zalomit(this,'BackgroundBlock');" colspan="1">Page Break: NO</span>
									</td>
								</tr>
							</table>
						</td>
						...
						<td width="100%" class="tableborder">
							<table width="100%" cellspacing="0" cellpadding="0" border="0">
								...
								<tr>
									<td class="rowsummary">
										CONCEPT
										<span class="rowsummarybutton" onClick="showhide(this,'ConceptBlock');" colspan="1">Show: YES</span>
										<span class="rowsummarybutton" onClick="zalomit(this,'ConceptBlock');" colspan="1">Page Break: NO</span>
									</td>
								</tr>
							</table>
						</td>
						...
						<td width="100%" class="tableborder">
							<table width="100%" cellspacing="0" cellpadding="0" border="0">
								...
								<tr>
									<td class="rowsummary">
										NOTES
										<span class="rowsummarybutton" onClick="showhide(this,'NotesBlock');" colspan="1">Show: YES</span>
										<span class="rowsummarybutton" onClick="zalomit(this,'NotesBlock');" colspan="1">Page Break: NO</span>
									</td>
								</tr>
							</table>
						</td>
									...
									<td width="50%" valign="top">
										<table width="100%" cellspacing="0" cellpadding="0" border="0" class="tableborder">
											...
											<tr>
												<td class="rowsummary" colspan="3">
													KARMA EXPENSES
													<span class="rowsummarybutton" onClick="showhide(this,'ExpensesBlock');" colspan="1">Show: YES</span>
													<span class="rowsummarybutton" onClick="zalomit(this,'ExpensesBlock');" colspan="1">Page Break: NO</span>
												</td>
											</tr>
										</table>
									</td>
		...
		<xsl:for-each select="msxsl:node-set($sortedlist)/spell">
                <xsl:choose>
									<xsl:when test="position() = 1">
										<tr><td colspan="7" style="border-bottom:solid black 1px;"><strong><xsl:value-of select="category" /> Spells</strong></td></tr>
									</xsl:when>
                  <xsl:otherwise>
                    <xsl:choose>
	...
	<xsl:template name="complexforms">
								<tr>
									<td colspan="5" valign="top">
										Stream: <xsl:value-of select="stream" />&#160;&#160;&#160;
