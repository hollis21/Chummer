				...
				switch (objXmlItem.Name)
				{
					...
					case "martialarts":
						...
						foreach (XmlNode objXmlArt in objXmlItem.SelectNodes("martialart"))
						{
							...
							{
								XmlNode objChildNode = objXmlItemDocument.SelectSingleNode("/chummer/martialarts/martialart[name = \"" + objXmlArt["name"].InnerText + "\"]/advantages/advantage[name = \"" + objXmlAdvantage.InnerText + "\"]");
