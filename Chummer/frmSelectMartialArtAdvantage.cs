...
namespace Chummer
{
	public partial class frmSelectMartialArtAdvantage : Form
	{
		...
		private void frmSelectMartialArtAdvantage_Load(object sender, EventArgs e)
		{
			...
			XmlNodeList objXmlAdvantageList = _objXmlDocument.SelectNodes("/chummer/martialarts/martialart[(" + _objCharacter.Options.BookXPath() + ") and name = \"" + _strMartialArt + "\"]/advantages/advantage");
