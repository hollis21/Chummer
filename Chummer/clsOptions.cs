...
namespace Chummer
{
	...
	public class CharacterOptions
	{
        ...
        private bool _startWithAverageAttributes = false;
        private bool _contactCostUsesMultiply = false;
		...
		public void Save()
		{
            ...
            // <startwithaverageattributes />
            objWriter.WriteElementString("startwithaverageattributes", _startWithAverageAttributes.ToString());
            // <contactCostUsesMultiply />
            objWriter.WriteElementString("contactcostusesmultiply", _contactCostUsesMultiply.ToString());
			// <bpcost>
		...
		public bool Load(string strFileName)
		{
            ...
            // House rule: Contacts cost Loyalty x Connection
            try
            {
                _contactCostUsesMultiply = Convert.ToBoolean(objXmlDocument.SelectSingleNode("/settings/contactcostusesmultiply").InnerText);
            }
            catch
            {
                MessageBox.Show("WTF");
            }
            // New characters start with average attributes.
            try
            {
                _startWithAverageAttributes = Convert.ToBoolean(objXmlDocument.SelectSingleNode("/settings/startwithaverageattributes").InnerText);
            }
            catch
            {
            }
        ...
        /// New characters start with average attributes.
        /// </summary>
        public bool StartWithAverageAttributes
        {
            get
            {
                return _startWithAverageAttributes;
            }
            set
            {
                _startWithAverageAttributes = value;
            }
        }
        public bool ContactCostUsesMultiply
        {
            get
            {
                return _contactCostUsesMultiply;
            }
            set
            {
                _contactCostUsesMultiply = value;
            }
        }
		#endregion
